...
{
    ray.first -= glm::vec4(m_pos, 0);
    ray.second -= glm::vec4(m_pos, 0);
    ...
    glm::vec3 intersect_point = glm::vec3(ray.first + glm::vec4(direction * float(intersect_t_val), 0));
    // std::cout << "----------------" << std::endl;
