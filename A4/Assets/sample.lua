...
glass = gr.material({0.4, 0.4, 0.4}, {0.5, 0.7, 0.5}, 25, 1.309, 0.7)

scene_root = gr.node('root')

s1 = gr.nh_sphere('s1', {0, -30, -200}, 50)
scene_root:add_child(s1)
s1:set_material(mat1)

s6 = gr.nh_sphere('s6', {0, 0, -125}, 50)
...
gr.render(scene_root, 'sample1.png', 800, 450,
